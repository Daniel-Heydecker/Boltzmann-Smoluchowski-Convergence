\section{Energy-Biasing Effect} \label{sec: EB}
...
% \dhcomment{This is a cute result, but if we want to cut anything, it should be this. We can obtain a crude bound, that $\frac{E_t}{M_t} \ge \frac{1}{2}\int |v|^2m(dv)$ very easily by correlation inequalities - while not sharp it will save several pages.}