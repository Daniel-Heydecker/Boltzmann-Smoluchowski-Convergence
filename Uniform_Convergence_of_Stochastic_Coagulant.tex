...
\begin{proof}[Proof of Theorem \ref{thrm: convergence of stochastic coagulent}] From the form (\textcolor{red}{...}) of the metric $d_0$, it is sufficient to prove that, for any $f\in C_c(S)$, \begin{equation}
