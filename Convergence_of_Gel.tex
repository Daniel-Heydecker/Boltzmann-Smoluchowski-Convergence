...
We now prove the remaining part of Theorem \ref{thrm: convergence of stochastic coagulent}, concerning the convergence of the stochastic gel: \begin{equation} M^N_t\rightarrow M_t; \hspace{1cm} P^N_t\rightarrow P_t;\hspace{1cm} E^N_t\rightarrow E_t\end{equation} uniformly, in probability.  The proof builds on the ideas of Lemma \ref{lemma: WCOG}, with suitable modifications to work uniformly in time. We recall that, in the proof of Lemma \ref{lemma: WCOG}, we used the result from \cite{BJR07} that, if $\xi_N\rightarrow \infty$ and $\frac{\xi_N}{N}\rightarrow 0$, then for all $t\ge 0$, \begin{equation} \frac{1}{N}\sum_{j\ge 2: C_j(G^N_t)\ge \xi_N} C_j(G^N_t)\rightarrow 0 \end{equation} in probability. We now generalise this to a uniform version.
